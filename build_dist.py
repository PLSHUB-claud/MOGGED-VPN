...
HIDDEN_IMPORTS = ['PIL', 'PIL.Image', 'PIL.ImageTk', 'PIL.ImageDraw', 'PIL.ImageFilter', 'PIL.ImageFont', 'pystray', 'pystray._win32', 'win32gui', 'win32ui', 'win32con', 'winreg', 'ctypes', 'urllib.request', 'json', 'logging', 'csv', 'base64', 'ipaddress', 'subprocess', 'threading', 'queue', 're', 'tempfile']
